...
echo "=                                                                                         ="
echo "=    - start business process via one of the following methods:                           ="
echo "=                                                                                         ="
echo "=       1. Using External UI Form http://localhost:8080/retailer-external-form-1.0/       ="
echo "=       2. Using form available via Business Central                                      ="
echo "=                                                                                         ="
echo "=    - login to JBoss Administration Console via following link:                          ="
echo "=                                                                                         ="
echo "=       http://localhost:9990/console/index.html (u:admin/p:jbosseap1!)                   ="
echo "=                                                                                         ="
